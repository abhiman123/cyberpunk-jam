...
export const SOUND_ASSETS = Object.freeze({
    ...
    // Day 2 manager voice assets now point at the shipped public filenames.
    phoneDay2Intro1: createSoundAsset('voice', 'phone_day2_intro_1', 'day2_line_1.wav'),
    phoneDay2Intro2: createSoundAsset('voice', 'phone_day2_intro_2', 'day2_line_2.wav'),
    phoneDay2YesLine1: createSoundAsset('voice', 'phone_day2_yes_line_1', 'day2_no_line_3.wav'),
    phoneDay2NoLine1: createSoundAsset('voice', 'phone_day2_no_line_1', 'day2_no_line_3.wav'),
    phoneDay2NoLine2: createSoundAsset('voice', 'phone_day2_no_line_2', 'day2_no_line4.wav'),
    phoneDay2NoLine3: createSoundAsset('voice', 'phone_day2_no_line_3', 'day2_no_line_5.wav'),
    ...
    sequences: Object.freeze({
        ...
        '2-1': createIntroSequence({
            ...
            no: [
                ...
                createIntroSequenceLine('line4', "I'd recommend you check out the rulebook but watch out for contraband marks or other things that look wrong.", SOUND_ASSETS.phoneDay2NoLine2),
                createIntroSequenceLine('line5', 'Remember, it can be fixable but still not meet quota and as always, shift ends at 12. good luck', SOUND_ASSETS.phoneDay2NoLine3),
            ],
        }),
